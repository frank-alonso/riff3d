...
must_haves:
  truths:
    ...
    - "All carry-forward items from Phase 1 (CF-01 through CF-06) are resolved"
    - "No S0 or S1 findings block Phase 2 completion"
    - "Codex review produces PASS or PASS_WITH_CONDITIONS gate decision"
  artifacts:
    - path: ".planning/reviews/phase-2/PHASE_2_PLAN_SUMMARY.md"
      provides: "Pre-execution plan summary for Codex review"
      contains: "Phase 2"
...
<objective>
Conduct the Phase 2 Review following the Phase Review Protocol. This includes pre-execution plan review (advisory) and post-execution evidence audit with Codex as independent reviewer. The review validates all 19 requirements, 5 success criteria, and carry-forward resolution.
...
Output: Review artifacts, gate decision (PASS, PASS_WITH_CONDITIONS, or FAIL).
</objective>
